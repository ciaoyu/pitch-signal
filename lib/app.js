...
function loadDataFiles(teamResolver) {
  ...
  try {
    const ratingsPath = path.join(__dirname, '..', 'data', 'sources', 'seed', 'wc2026', 'player-ratings.json');
  ...
  try {
    const bridgePath = path.join(__dirname, '..', 'data', 'sources', 'seed', 'wc2026', 'id_bridge.json');
