...
function computeTeamExperience(db, teamId, excludeMatchId) {
  if (!teamId) return { matchesPlayed: 0, goals: 0, assists: 0, yellows: 0, reds: 0, wentToEt: false, decidedByPens: false };
  ...
  if (matchesPlayed === 0) return { matchesPlayed: 0, goals: 0, assists: 0, yellows: 0, reds: 0, wentToEt: false, decidedByPens: false };
  ...
  return { matchesPlayed, goals, assists, yellows, reds, wentToEt, decidedByPens };
}
