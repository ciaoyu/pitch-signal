...
function computeTeamGameStateStats(teamId, db) {
  ...
  try {
    ...
    return {
      ...
      tookLeadMatches,
      heldLeadMatches,
      leadHoldRate: tookLeadMatches > 0 ? round2(heldLeadMatches / tookLeadMatches) : null,
      fellBehindMatches,
      recoveredMatches,
      comebackRate: fellBehindMatches > 0 ? round2(recoveredMatches / fellBehindMatches) : null,
    };
  } catch (_) {
    return {
      matchesAnalyzed: 0,
