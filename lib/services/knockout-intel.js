...
const SECTION_BUILDERS = [
  ...
  // { key: 'penalty',       build: (ctx) => buildPenaltySection(ctx) },       // KO-7/8
...
function normalizeCtx(raw = {}) {
  return {
    matchId: raw.matchId || raw.id || null,
    homeId: raw.homeId || raw.homeTeamId || null,
    awayId: raw.awayId || raw.awayTeamId || null,
    homeTeamId: raw.homeTeamId || raw.homeId || null,
    awayTeamId: raw.awayTeamId || raw.awayId || null,
    homeName: raw.homeName || raw.home || null,
    awayName: raw.awayName || raw.away || null,
    stage: raw.stage || null,
    nextRound: raw.nextRound || raw.stage || null,
    db: raw.db || null,
    matchDate: raw.matchDate || raw.date || null,
    strictLeakageCheck: raw.strictLeakageCheck || false,
  };
}
...
function buildKnockoutIntel(ctx = {}) {
  ...
  const guardedSections = guardKnockoutIntel(params, sections);
