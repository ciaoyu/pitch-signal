 ...
 *
 * 数据源：data/sources/seed/wc2026/player_id_bridge.json（由 build-player-id-bridge.js 生成）
...
const BRIDGE_PATH = path.join(__dirname, '..', 'data', 'sources', 'seed', 'wc2026', 'player_id_bridge.json');
