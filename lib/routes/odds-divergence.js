  ...
  return {
    ...
    'GET /api/odds-divergence/:matchId': async (params) => {
      ...
      try {
        ...
        // 「分歧」页面存在的唯一理由是独立对比"模型怎么看"与"市场怎么看"。
        // 用两次独立调用拿纯模型概率（不传 includeExternalOdds）——如果
        // modelProbs 本身已经混入了 20% 市场权重，分歧会被系统性拉小，
        // 页面就不再是分歧展示，而是"模型+市场 vs 市场"的温差，产品叙事失真。
