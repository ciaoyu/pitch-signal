...
function generateMockNews(homeTeam, awayTeam, matchDate, homeI18n = null, awayI18n = null) {
  const now = new Date();
  ...
  return {
    'GET /api/match/:id/news': async (params) => {
      ...
      if (newsItems.length === 0) {
        newsItems = generateMockNews(ctx.homeTeam, ctx.awayTeam, ctx.matchDate, homeNameI18n, awayNameI18n);
        source = 'mock';
      } else {
