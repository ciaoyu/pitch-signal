...
module.exports = function registerRoutes(routes, deps) {
  ...
  // PF-7: live World Cup Winner title-odds (standalone display, no fusion)
  const polymarketModule = safeRequire('polymarket');
  const polymarketRoutes = polymarketModule ? safeLoadRoutes('polymarket', polymarketModule, deps) : {};
  ...
  Object.assign(routes, coreRoutes, predictionRoutes, entityRoutes, newsRoutes, botRoutes, healthRoutes, matchupRoutes, oddsRoutes, oddsDivergenceRoutes, userPredictionsRoutes, pushRoutes, standingsRoutes, venueRoutes, coachRoutes, lineupsRoutes, askRoutes, recentRoutes, calibrationRoutes, polymarketRoutes);
