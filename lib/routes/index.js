...
module.exports = function registerRoutes(routes, deps) {
  ...
  // 合并所有成功加载的路由
  Object.assign(routes, coreRoutes, predictionRoutes, entityRoutes, newsRoutes, botRoutes, healthRoutes, matchupRoutes, oddsRoutes, oddsDivergenceRoutes, userPredictionsRoutes, standingsRoutes, venueRoutes, coachRoutes, lineupsRoutes, askRoutes, recentRoutes);
