...
module.exports = function registerRoutes(routes, deps) {
  ...
  const newsRoutes = newsModule ? safeLoadRoutes('news', newsModule, {
    ...
    loader: deps.loader,
    getElo: deps.getElo || null,              // P2-5: Elo 上下文
    getTeamStyle: deps.getTeamStyle || null,  // P2-5: 战术风格上下文
    getQualificationForMatch: deps.getQualificationForMatch || null, // P2-5: 晋级上下文
  }) : {};
  ...
  // 合并所有成功加载的路由
  Object.assign(routes, coreRoutes, predictionRoutes, entityRoutes, newsRoutes, botRoutes, healthRoutes, matchupRoutes, oddsRoutes, oddsDivergenceRoutes, userPredictionsRoutes, pushRoutes, standingsRoutes, venueRoutes, coachRoutes, lineupsRoutes, askRoutes, recentRoutes);
