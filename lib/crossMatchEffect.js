...
function teamIdAliasSet(teamId) {
  ...
  if (r) {
    ...
    // review.match.home.name in database is a composite "Chinese English" format like "西班牙 Spain", which should also be covered
 ...
 *   - ratings_id ("Spain")
 *   - ESPN id ("164")
 *   - Chinese-English composite name ("西班牙 Spain")
