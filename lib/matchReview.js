...
class MatchReviewEngine {
  constructor(options = {}) {
    ...
    // 偏差分析影响因素定义
    this.biasFactors = {
      elo_gap: 'Elo 实力差',           // Elo 差距 vs 实际比分
      home_advantage: '主场优势',       // 实际主场效应高于/低于模型预期
      form_vs_rating: '近期状态 vs 历史能力', // 球队近期表现偏离长期 Elo
      upset_factor: '爆冷系数',        // 弱胜强 / 强平弱
      scoreline_variance: '比分方差',   // 实际进球数偏离 expected goals 的程度
      defensive_collapse: '防守崩溃',   // 失球数远超对手场均失球
      attacking_boom: '进攻爆发',       // 进球数远超对手场均失球
    };
  }
