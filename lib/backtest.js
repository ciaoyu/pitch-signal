...
class BacktestRunner {
  ...
  async _walkForward(matches, paramOverrides = null, evalFilter = null, opts = {}) {
    const { marketValueSignal: marketValueConfig, ...engineOverrides } = paramOverrides || {};
  ...
  async compareBaseline(proposedParams, baseline = null) {
    if (proposedParams && Object.keys(proposedParams).some(k => !['elo', 'poisson', 'weights', 'marketValueSignal'].includes(k))) {
