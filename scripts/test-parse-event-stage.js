...
// 1. Group Stage, missing notes, both in same group → fill in Group
...
// 2. R32, both originally in same group → must not fill in Group
...
// 3. R32/R16/QF/SF/Third Place/Final slug mapping
const mappingTests = {
  'round-of-32': 'R32',
  'round-of-16': 'R16',
  'quarterfinals': 'QF',
