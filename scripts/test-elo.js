...
console.log('=== Elo rating engine tests ===\n');

// 1. Expected win-rate test
console.log('📊 Expected win-rate test:');
...
// 2. FIFA ranking conversion
console.log('\n📊 FIFA ranking → Elo conversion:');
...
// 3. Simulated match rating update
console.log('\n📊 Simulated match: Brazil (1800) vs Germany (1750), 3-1');
...
// 4. Simulated draw
console.log('\n📊 Simulated match: Argentina (1850) vs France (1850), 1-1');
...
// 5. Match prediction
console.log('\n📊 Match prediction: Brazil (1800) vs Switzerland (1600)');
